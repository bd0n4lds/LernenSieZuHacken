...
VOID __stdcall DoStartFrasaso(void);
VOID __stdcall DoUpdateFrasasoDacl(void);
VOID __stdcall DoStopFrasaso(void);
...
//
// Parameters:
//   Command-line syntax is: Frasasocontrol [command] [service_name]
// 
// Return value:
//   None
//
...
VOID __stdcall DisplayUsage()
{
    ...
    printf("Usage:\n");
    printf("\tFrasasocontrol [command] [service_name]\n\n");
    printf("\t[command]\n");
    printf("\t  start\n");
    printf("\t  dacl\n");
    printf("\t  stop\n");
...
//   None
//
VOID __stdcall DoUpdateFrasasoDacl()
{
    EXPLICIT_ACCESS      ea;
